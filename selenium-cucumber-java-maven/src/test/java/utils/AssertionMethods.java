...
public class AssertionMethods extends AbstractPage implements BaseTest {
     ...
     * @param testCase    : Boolean : test case [true or false]
     */
    public void checkElementText(String accessType, String expectedValue, String accessName, boolean testCase)
     ...
     * @param testCase    : Boolean : test case [true or false]
     */
    public void checkElementPartialText(String accessType, String expectedValue, String accessName, boolean testCase)
            throws TestCaseFailed {
        String elementText = getElementText(accessType, accessName);
